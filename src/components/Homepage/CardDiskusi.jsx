                    ...
                    <Row>
                        ...
                        <div className="col-lg-8 col-7">
                            <Row>
                                ...
                                <div className="col-12"><p>Tolong infoin dimana ada badai? Mau penelitian Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est corrupti, rem doloribus enim distinctio aliquam sunt inventore sequi minima possimus qui porro ipsum molestiae tempore dolore deserunt quod. Corporis, sit?</p></div>
                            </Row>
                        </div>
                        <div className="col-lg-3 col-3 d-flex">
                            <Row className=''>
                                ...
                                <div className="col-12 d-flex justify-content-around">
                                    <span>129<i className="fa-regular fa-thumbs-up ms-1"></i></span>
