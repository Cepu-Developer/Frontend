            ...
            <Card className='rounded-4 border-0'>
                ...
                <Card.Body>
                    <Card.Link href='' className='text-success fw-bold d-flex justify-content-between align-items-center'>
                        ...
                        <span className='fs-3'><GoArrowUpRight /></span>
                    </Card.Link>
                    <Card.Title className='fw-bold my-2'>Berita Terkini</Card.Title>
                    <Card.Text>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fugit non dolorem vero expedita iusto ducimus sint quae impedit ut
                    </Card.Text>
                </Card.Body>
            </Card>
        </Col>
